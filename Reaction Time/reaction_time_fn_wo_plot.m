...
= reaction_time_fn_wo_plot(name,date,Trial)
datasource = 'live_database';
conn = database(datasource,'postgres','1234');
% tablename = "live_table";
query = "SELECT subjectid, mazenumber, feeder, trialname, date," + ...
...
%
all_data.date = datetime(all_data.date,'InputFormat','MM/dd/yyyy');
data_on_date = all_data(all_data.date == char(date),:);
